...
function CreatBlogPage() {
  ...
  const { CreatBlogs } = useContext(AppContext);
  ...
  console.log(title, description, coverImg, content, category, Rating);
  const HandleSubmit = async (e) => {
    ...
    const res = await CreatBlogs(blogData);
    if (res.success == true) {
  ...
  return (
    <div>
      ...
      <div className="pl-[320px] py-[3rem]">
        <h1 className="text-xl font-medium text-gray-800 my-3">Add A Blog</h1>
        <form
          action=""
